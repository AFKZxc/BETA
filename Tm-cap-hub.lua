...
{Image = "http://www.roblox.com/asset/?id=17864247888", ImageColor = Color3.fromRGB(255, 255, 255)}
)id=17864247888", ImageColor = Color3.fromRGB(255, 255, 255)}
)
wait(0.4)
...
print("用户界面库加载成功！")
----------------------------------------------------------------------------------------------------------------------------------------
local window = library:new("ERT云")--V2.1.3
----------------------------------------------------------------------------------------------------------------------------------------
...
local TDS = window:Tab("TDS&TDX", "603109722ddjdndnndndn9")--20二个服务器
...
local a= window:Tab("蜂群模拟器", "6031097229")--41
